...
/* 5x7 monospace ASCII font — the classic "GLCD" / Adafruit-style glyph table.
 *
 * Each character is 5 bytes; each byte is one vertical column of 8 pixels.
 * Bit 0 (LSB) is the top pixel, bit 7 (MSB) is the bottom. The font occupies
 * rows 0..6, leaving row 7 blank to act as inter-line spacing.
 *
 * Coverage: ASCII 0x20 (space) through 0x7E (tilde) — 95 glyphs, 475 bytes. */
